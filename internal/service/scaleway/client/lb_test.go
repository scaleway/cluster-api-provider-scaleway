...
func TestClient_CreateLB(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := c.CreateLB(tt.args.ctx, tt.args.zone, tt.args.name, tt.args.lbType, tt.args.ipID, tt.args.tags)
			if (err != nil) != tt.wantErr {
...
func TestClient_AttachLBPrivateNetwork(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := c.AttachLBPrivateNetwork(tt.args.ctx, tt.args.zone, tt.args.lbID, tt.args.privateNetworkID); (err != nil) != tt.wantErr {
