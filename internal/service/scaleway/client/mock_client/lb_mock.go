...
func (mr *MockLBMockRecorder) AttachLBPrivateNetwork(ctx, zone, lbID, privateNetworkID any) *MockLBAttachLBPrivateNetworkCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AttachLBPrivateNetwork", reflect.TypeOf((*MockLB)(nil).AttachLBPrivateNetwork), ctx, zone, lbID, privateNetworkID)
...
// Do rewrite *gomock.Call.Do
func (c *MockLBAttachLBPrivateNetworkCall) Do(f func(context.Context, scw.Zone, string, string) error) *MockLBAttachLBPrivateNetworkCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLBAttachLBPrivateNetworkCall) DoAndReturn(f func(context.Context, scw.Zone, string, string) error) *MockLBAttachLBPrivateNetworkCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// CreateLB mocks base method.
func (m *MockLB) CreateLB(ctx context.Context, zone scw.Zone, name, lbType string, ipID *string, tags []string) (*lb.LB, error) {
	m.ctrl.T.Helper()
...
// CreateLB indicates an expected call of CreateLB.
func (mr *MockLBMockRecorder) CreateLB(ctx, zone, name, lbType, ipID, tags any) *MockLBCreateLBCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateLB", reflect.TypeOf((*MockLB)(nil).CreateLB), ctx, zone, name, lbType, ipID, tags)
...
// Do rewrite *gomock.Call.Do
func (c *MockLBCreateLBCall) Do(f func(context.Context, scw.Zone, string, string, *string, []string) (*lb.LB, error)) *MockLBCreateLBCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLBCreateLBCall) DoAndReturn(f func(context.Context, scw.Zone, string, string, *string, []string) (*lb.LB, error)) *MockLBCreateLBCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
