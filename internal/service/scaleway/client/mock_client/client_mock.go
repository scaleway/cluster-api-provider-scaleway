...
func (m *MockInterface) AttachLBPrivateNetwork(ctx context.Context, zone scw.Zone, lbID, privateNetworkID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AttachLBPrivateNetwork", ctx, zone, lbID, privateNetworkID)
	ret0, _ := ret[0].(error)
	return ret0
}

// AttachLBPrivateNetwork indicates an expected call of AttachLBPrivateNetwork.
func (mr *MockInterfaceMockRecorder) AttachLBPrivateNetwork(ctx, zone, lbID, privateNetworkID any) *MockInterfaceAttachLBPrivateNetworkCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AttachLBPrivateNetwork", reflect.TypeOf((*MockInterface)(nil).AttachLBPrivateNetwork), ctx, zone, lbID, privateNetworkID)
...
// Do rewrite *gomock.Call.Do
func (c *MockInterfaceAttachLBPrivateNetworkCall) Do(f func(context.Context, scw.Zone, string, string) error) *MockInterfaceAttachLBPrivateNetworkCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockInterfaceAttachLBPrivateNetworkCall) DoAndReturn(f func(context.Context, scw.Zone, string, string) error) *MockInterfaceAttachLBPrivateNetworkCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockInterface) CreateLB(ctx context.Context, zone scw.Zone, name, lbType string, ipID *string, tags []string) (*lb.LB, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateLB", ctx, zone, name, lbType, ipID, tags)
	ret0, _ := ret[0].(*lb.LB)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockInterfaceMockRecorder) CreateLB(ctx, zone, name, lbType, ipID, tags any) *MockInterfaceCreateLBCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateLB", reflect.TypeOf((*MockInterface)(nil).CreateLB), ctx, zone, name, lbType, ipID, tags)
...
// Do rewrite *gomock.Call.Do
func (c *MockInterfaceCreateLBCall) Do(f func(context.Context, scw.Zone, string, string, *string, []string) (*lb.LB, error)) *MockInterfaceCreateLBCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockInterfaceCreateLBCall) DoAndReturn(f func(context.Context, scw.Zone, string, string, *string, []string) (*lb.LB, error)) *MockInterfaceCreateLBCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
